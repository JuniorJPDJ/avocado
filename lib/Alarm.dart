...
class Alarm implements StringSerializable {
  ...
  Alarm(this.source, this._name, this._value, this._greater, [this._enabled = true, this._snoozedTo]){
  ...
  String get instanceData => "${source.sourceId}|$name|$value|$greater|$enabled|$snoozedTo";
